...
namespace EmployeePayments
{
    public partial class Form1 : Form
    {
        ...
        */
         ...
         * 2.- Six variables are declared
         * 3.- Compares if the amount of houris greater than 0
         * 4.- Calculates the hourly rate of the overtime and calculates the proper salary
         * 5.- Displays the values in the proper textbox's
         *     
        */
        ...
        /**
         * 1.- The clearText method, clears all the values in the texbox's. 
        */
